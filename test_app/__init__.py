...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://{user}:{password}@{server}:{port}/{database}'.format(user='root',password='HackMeIfYouCan@37HahA',server='127.0.0.1', database='test_db', port=3307)
